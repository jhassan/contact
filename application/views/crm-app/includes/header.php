            ...
            <div class="nicescroll-bar">
                <div class="navbar-nav-wrap">
                    ...
                    <?php endif; ?>
                        ...
                        <li class="nav-item active" style="margin: 0 auto;">
                        <a style="margin: 6px;" href="<?php echo site_url('request/create_request'); ?>" class="btn btn-primary">Create Request</a>
                        <a style="margin: 6px;" href="<?php echo site_url('request/view_request'); ?>" class="btn btn-primary">View/Edit Request</a>
                        </li>
                    </ul>
                </div>
            </div>
